...
- Consumer status: branch `feat/pi-tool-browse-detail-convergence` starts from `99b96dc4`, resolves Kit `0.53.0`, removes the duplicate browser and Pi TUI dependency, and passes 12 focused tests plus the 2,979-test repository gate. Its 6-file tarball independently installs with registry Kit `0.53.0`.
