...
- [x] Focused tests, all pi-sync tests, `npm run check`, and `just pack sync` pass with evidence. Evidence: 10 state-directory tests, 304 final pi-sync tests, 2,591 root tests, and the 52-file pack inspection pass.
